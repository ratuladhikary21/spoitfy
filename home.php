    ...
    <div class="main-container">
      <div class="topbar">
        ...
        <div class="navbar">
          ...
          <button class="login-signup btn btn-warning"><a href="logout.php" style="color:black">Logout</a></button>
        </div>
      </div>
